...
#-----------------Border Encounters by US Region: 2004–2025-----------------
...
labs(
    title = "Border Encounters by Region: 2004–2024",
...
#-----------------Top Encounters by Origin: 2004–2025-----------------
...
ggplot(top_annual_origin_encounters, aes(x = Year, y = Total, color = Origin)) +
  ...
  labs(
    title = "Top Encounters by Origin: 2004–2025",
    caption = "Source: Office of Homeland Security Statistics - Customs & Border Patrol Encounters",
    x = "Year",
    y = "Encounters"
  ) +
...
ggplot(annual_familystatus_encounters, aes(x = Year, y = Total, fill = Family)) +
  ...
  labs(title = 'Encounters by Family Status: 2004–2025',
       caption = "Source: Office of Homeland Security Statistics - Customs & Border Patrol Encounters",
       x = 'Year',
       y = 'Encounters',
       fill = 'Family Status') +
